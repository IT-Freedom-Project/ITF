#!/usr/bin/env bash
echo "\nСкрипт для создания, изменения и передачи SSH-ключей (RSA или ED25519) от IT Freedom Project v1.0 (https://www.youtube.com/@it-freedom-project), (https://github.com/IT-Freedom-Project/Youtube)\n"
#======================================================================
