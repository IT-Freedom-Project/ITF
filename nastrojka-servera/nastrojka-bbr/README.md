# Настройка BBR для ускорения сети linux-сервера
...
\
```sudo wget -O bbr-itf.sh https://raw.githubusercontent.com/IT-Freedom-Project/ITF/main/nastrojka-servera/nastrojka-bbr/bbr-itf.sh && sudo bash bbr-itf.sh```\
\
или эту: \
\
```sudo curl -o bbr-itf.sh https://raw.githubusercontent.com/IT-Freedom-Project/ITF/main/nastrojka-servera/nastrojka-bbr/bbr-itf.sh && sudo bash bbr-itf.sh``` \
\
Или делаем вручную:
